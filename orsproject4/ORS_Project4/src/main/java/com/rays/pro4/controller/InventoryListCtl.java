...
/**
 * Inventory List functionality Controller. Performs operation for list, search
 * and delete operations of Inventory
 * 
...
public class InventoryListCtl extends BaseCtl {
	...
	protected void preload(HttpServletRequest request) {
		...
		InventoryModel smodel = new InventoryModel();

		try {

			List slist = smodel.list(0, 0);

			request.setAttribute("Supplier_Name", slist);
		...
		request.setAttribute("inventory", map);
