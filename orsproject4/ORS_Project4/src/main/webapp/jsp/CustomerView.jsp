...
<body>
   ...
   <center>
    ...
    <div align="center">    
            ...
            <tr><th><font size="5px"> Update Customer </font>  </th></tr>
            	<%}else{%>
			<tr><th><font size="5px"> Add Customer </font>  </th></tr>            
            	<%}%>
            </h1>
            ...
            <table>
                <tr>
                    ...
                    <td><input type="text" name="clientName" placeholder="Enter Client Name" size="26"  value="<%=DataUtility.getStringData(bean.getClientName())%>"></td>
    ...
    <tr><th style="padding: 3px"></th></tr>          
              ...
              <tr>
                    ...
                    <td><input type="text" name="location" placeholder="Enter Location" size="26" value="<%=DataUtility.getStringData(bean.getLocation())%>"></td>
    ...
    <tr><th style="padding: 3px"></th></tr>          
                ...
                <tr>
                    ...
                    <td><input type="text" name="contactNumber" maxlength="10" placeholder="Enter Contact Number" size="26" value="<%=(DataUtility.getStringData(bean.getContactNumber()).equals("0")?"" : bean.getContactNumber())%>"> </td>
                ...
                <tr>
                    ...
                    <td>
                        <%
                            ...
                            String hlist = HTMLUtility.getList("importance", DataUtility.getStringData(bean.getImportance()), map);
    						%> <%=hlist%>
                   </td>
    ...
    <tr><th style="padding: 3px"></th></tr> 
                ...
                <td colspan="2" >
                &nbsp;  &emsp;
                    <input type="submit" name="operation" value="<%=CustomerCtl.OP_UPDATE%>">
                      &nbsp;  &nbsp;
                    <input type="submit" name="operation" value="<%=CustomerCtl.OP_CANCEL%>"></td>
                
                <% }else{%>
                
                <td colspan="2" > 
                &nbsp;  &emsp;
                    <input type="submit" name="operation" value="<%=CustomerCtl.OP_SAVE%>">
                    &nbsp;  &nbsp;
                    <input type="submit" name="operation" value="<%=CustomerCtl.OP_RESET%>"></td>
