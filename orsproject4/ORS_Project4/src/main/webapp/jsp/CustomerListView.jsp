			...
			<table width="100%" align="center">
			   <input type="hidden" name="id" value="<%=bean.getId()%>">
				<tr>
					...
					</label> <input type="text" name="clientName" placeholder="Enter Client Name"
						value="<%=ServletUtility.getParameter("clientName", request)%>">

						&nbsp; <label>Contact Number</font> :
					</label> <input type="text" name="contactNumber" placeholder="Enter Contact Number"
						value="<%=ServletUtility.getParameter("contactNumber", request)%>">
						
						&emsp; <label>Location</font> :
					</label> <%=HTMLUtility.getList("location", DataUtility.getStringData(bean.getLocation()), clist)%>
